          ...
          <div className='textWrapper'>
            ...
            <WineTimeList>
              ...
              <li>
                ...
                <p>
                  Time moves quickly, and with us you can always get a new
                  chance to discover new tastes. So don't miss your wine hour!
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <h3>Special offer:</h3>
                <p>
                  Now, when the clock reads, for example, 6:59, you get a
                  special discount on wine from the country where that time is.
                  For example, if it's 6:59 a.m. in France, you get a discount
                  on French wine.
                </p>
              </li>
            </WineTimeList>
